(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`n8n@2.30.4`}}catch{}})();try{(function(){var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{},t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`0c85b962-df6c-4224-8ab3-8c03cdea99b0`,e._sentryDebugIdIdentifier=`sentry-dbid-0c85b962-df6c-4224-8ab3-8c03cdea99b0`)})()}catch{}import{It as e,Nt as t,Pt as n,S as r,gt as i}from"./vue.runtime.esm-bundler-CN6Xq3ZO.js";import{s as a}from"./src-CKGerW84.js";import{_t as o,gt as s}from"./src-BEZ5Nz-y.js";import{v as c}from"./core-9tF8rONZ.js";import{t as l}from"./useToast-D4cRzJXC.js";import{$l as u,di as d,jd as f,yl as p}from"./constants-DH1EtWPu.js";import{at as m,cn as h,hn as g}from"./workflowDocument.store-awp5zzf_.js";import{T as _}from"./useRootStore-iDsSoeVQ.js";import{Vn as v,t as y}from"./settings.store-30PpMGzd.js";import{g as b,p as x,t as S}from"./users.store-BNHG4ORB.js";import{t as C}from"./cloudPlan.store-Be-NLI6F.js";import{t as w}from"./dataTable.store-d_fe-5il.js";import{t as T}from"./folders.store-DotavrZC.js";var E={name:`AI Agent workflow`,meta:{templateId:`ready-to-run-ai-workflow`},nodes:[{parameters:{url:`https://www.theverge.com/rss/index.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[128,448],id:`a26f16ce-82a5-4392-a032-622467e0098f`,name:`Get Tech News`},{parameters:{toolDescription:`Reads the news`,url:`=https://feeds.bbci.co.uk/news/world/rss.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[272,448],id:`91d1a929-b913-4399-977a-4306fe8349c7`,name:`Get World News`},{parameters:{model:{__rl:!0,mode:`list`,value:`gpt-4.1-mini`},options:{}},type:`@n8n/n8n-nodes-langchain.lmChatOpenAi`,typeVersion:1.2,position:[-144,448],id:`482c5e90-74ea-424c-9ec3-1dc14dd460f9`,name:`OpenAI Model`,notesInFlow:!0,credentials:{},notes:`Free n8n credits `},{parameters:{promptType:`define`,text:`=Provide a summary of world and tech news from the last 24 hours. 
...
Today is {{ $today }}
`}},type:`@n8n/n8n-nodes-langchain.agent`,typeVersion:3,position:[192,64],id:`ce5dd204-b9d3-4455-ab0c-0c2ce314ad52`,name:`AI Agent`}],pinData:{},connections:{"When chat message received":{main:[[{node:`AI Agent`,type:`main`,index:0}]]},"OpenAI Model":{ai_languageModel:[[{node:`AI Agent`,type:`ai_languageModel`,index:0}]]},"Simple Memory":{ai_memory:[[{node:`AI Agent`,type:`ai_memory`,index:0}]]},Hackernews:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},TheVerge:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"BBC News":{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"Google Sheets":{ai_tool:[[]]}}},j=_(v.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2,()=>{let e=b(),t=C(),n=r(()=>e.getVariant(f.name)),i=r(()=>n.value===f.variant5),a=r(()=>n.value===f.variant6),o=r(()=>t.userIsTrialing&&(i.value||a.value));return{currentVariant:n,getWorkflowForVariant:()=>{if(o.value){if(i.value)return k;if(a.value)return A}},isFeatureEnabled:o}}),M=`N8N_READY_TO_RUN_OPENAI_CREDENTIAL_ID`,N=_(v.READY_TO_RUN,()=>{let n=[`ready-to-run-ai-workflow`,`ready-to-run-ai-workflow-v5`,`ready-to-run-ai-workflow-v6`],s=x(),f=a(),g=l(),_=o(),v=m(),b=S(),C=y(),w=h(),T=j(),D=c(M,``),k=e(!1),A=r(()=>!!v.allCredentials.filter(e=>e.type===u).length),N=r(()=>!!b.currentUser?.settings?.userClaimedAiCredits),P=336*60*60*1e3,F=e(Date.now()),I,L=()=>{I!==void 0&&(clearTimeout(I),I=void 0)},R=()=>{let e=b.currentUser?.createdAt;if(!e)return;let t=new Date(e).getTime();return Number.isFinite(t)?t:void 0},z=()=>{L();let e=R();if(e===void 0)return;let t=e+P-Date.now();t<=0||(I=setTimeout(()=>{F.value=Date.now(),I=void 0},t))};i(()=>b.currentUser?.createdAt,()=>{F.value=Date.now(),z()},{immediate:!0}),t(()=>{L()});let B=()=>{let e=R();return e===void 0?!1:F.value-e<P},V=r(()=>C.isAiCreditsEnabled&&!A.value&&!N.value),H=e=>{s.track(`User executed ready to run AI workflow`,{status:e})},U=()=>{s.track(`User executed ready to run AI workflow successfully`)},W=async e=>{k.value=!0;try{let t=await v.claimFreeAiCredits(e);return D.value=t.id,s.track(`User claimed OpenAI credits`),t}catch(e){throw g.showError(e,f.baseText(`freeAi.credits.showError.claim.title`),{message:f.baseText(`freeAi.credits.showError.claim.message`)}),e}finally{k.value=!1}},G=()=>T.getWorkflowForVariant()??E,K=async(e,t)=>{s.track(`User opened ready to run AI workflow`,{source:e});try{let e={...G(),parentFolderId:t},n=D.value;if(n&&e.nodes){let t=p(e),r=t.nodes?.find(e=>e.name===`OpenAI Model`);r&&(r.credentials??={},r.credentials[u]={id:n,name:``}),e=t}let r=await w.createNewWorkflow(e);return await _.push({name:d.WORKFLOW,params:{workflowId:r.id}}),r}catch(e){throw g.showError(e,f.baseText(`generic.error`)),e}},q=async(e,t,n)=>{await W(n),await K(e,t),b?.currentUser?.settings&&(b.currentUser.settings.userClaimedAiCredits=!0)},J=(e,t)=>V.value&&!t&&e,Y=(e,t,n)=>V.value&&!n&&t&&e&&B(),{isTrulyEmpty:X}=O();return{claimingCredits:k,userCanClaimOpenAiCredits:V,claimFreeAiCredits:W,createAndOpenAiWorkflow:K,claimCreditsAndOpenWorkflow:q,getCardVisibility:J,getButtonVisibility:Y,getSimplifiedLayoutVisibility:e=>X(e),trackExecuteAiWorkflow:H,trackExecuteAiWorkflowSuccess:U,isReadyToRunTemplateId:e=>!!e&&n.includes(e)}});export{E as a,D as i,k as n,O as r,N as t};
//# sourceMappingURL=readyToRun.store-CdQEb31-.js.map